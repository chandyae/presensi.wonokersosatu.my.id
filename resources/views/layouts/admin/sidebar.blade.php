<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('tabler/static/logo-white.svg') }}" width="220" height="64" alt="Tabler"
                ...
                @role('administrator', 'user')
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu  {{ request()->is(['konfigurasi', 'konfigurasi/*']) ? 'show' : '' }}">
                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item  {{ request()->is(['konfigurasi/hari_libur']) ? 'active' : '' }}"
                                        href="/konfigurasi/hari_libur">
                                        Hari Libur
                                    </a>
