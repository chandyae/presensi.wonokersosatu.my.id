                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="kode_cabang" class="form-control" placeholder="Kode Sekolah" name="kode_cabang">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_cabang" value="" class="form-control" name="nama_cabang" placeholder="Nama Sekolah">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="lokasi_cabang" value="" class="form-control" name="lokasi_cabang" placeholder="Lokasi Sekolah">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="radius_cabang" value="" class="form-control" name="radius_cabang" placeholder="Radius Sekolah">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
