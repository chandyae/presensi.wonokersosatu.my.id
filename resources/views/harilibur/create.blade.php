<form action="/konfigurasi/hari_libur/store" method="POST" id="frmcreateHarilibur">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="kode_libur"
                    class="form-control" placeholder="Auto" name="kode_libur" disabled>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="tanggal_libur"
                    class="form-control" placeholder="Tanggal Libur" name="tanggal_libur" autocomplete="off">
            </div>
        </div>
    </div>
    <!-- <div class="row mb-3">
        ...
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="keterangan"
                    class="form-control" placeholder="Keterangan" name="keterangan" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row mt-2">
