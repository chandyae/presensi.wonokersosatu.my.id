...
Route::group(['middleware' => ['role:administrator,user']], function () {
    ...
    //Harilibur
    Route::get('/konfigurasi/hari_libur', [HariliburController::class, 'index']);
    Route::get('/konfigurasi/hari_libur/create', [HariliburController::class, 'create']);
    Route::post('/konfigurasi/hari_libur/store', [HariliburController::class, 'store']);
    Route::post('/konfigurasi/hari_libur/edit', [HariliburController::class, 'edit']);
    Route::post('/konfigurasi/hari_libur/{kode_libur}/update', [HariliburController::class, 'update']);
    Route::post('/konfigurasi/hari_libur/{kode_libur}/delete', [HariliburController::class, 'delete']);
